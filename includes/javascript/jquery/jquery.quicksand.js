    ...
    $.fn.quicksand = function (collection, customOptions) {
        ...
        return this.each(function (i) {
            ...
            $source.each(function (i) {
                ...
                var dd = $(rawObj).position();

                rawObj.style.top = (offsets[i].top - parseFloat(rawObj.style.marginTop) - correctionOffset.top + dy) + 'px';
                rawObj.style.left = (offsets[i].left - parseFloat(rawObj.style.marginLeft) - correctionOffset.left + dx) + 'px';

                //rawObj.style.top = (dd.top - parseFloat(rawObj.style.marginTop) - correctionOffset.top + dy) + 'px';
                //rawObj.style.left = (dd.left - parseFloat(rawObj.style.marginLeft) - correctionOffset.left + dx) + 'px';

                //rawObj.style.top = (parseFloat(dd.top)  - correctionOffset.top + dy) + 'px';
                //rawObj.style.left = (parseFloat(dd.left) - correctionOffset.left + dx) + 'px';
