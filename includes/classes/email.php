...
// - Moved interface mail function here renamed to send_mail
// To use create the class and invoke the send_mail function
//----------------------------------------------------------------------------
...
*/
  ...
  class email {
    ...
    function email($headers = '') {
      if ($headers == '') $headers = array('X-Mailer: I-Metrics Mailer');
