...
*/
?>
            <div class="infoBox bounder"><?php echo tep_draw_form($this->form_box, $link); ?>
              <div class="infoBoxHeading infoBoxHeading2 boxpadding"><?php echo $cStrings->BOX_HEADING_CAST_VOTE; ?></div>
