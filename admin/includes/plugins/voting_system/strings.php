...
$HEADING_CONFIGURATION_OPTIONS       = 'Configuration Options';
...
$TEXT_DISPLAY_COLUMN_LEFT            = 'Left';
$TEXT_DISPLAY_COLUMN_RIGHT           = 'Right';

$TEXT_TEXT_PAGES                     = 'Show on Text Pages';
$TEXT_TEXT_COLLECTIONS               = 'Show on Text Collections';
$TEXT_IMAGE_COLLECTIONS              = 'Show on Image Collections';
$TEXT_BOX_STEPS                      = 'Steps/Resolution for the box selection options';
$TEXT_MOD_STEPS                      = 'Steps/Resolution for the module selection options';

$ERROR_INVALID_DATABASE_FILE         = 'Invalid or Empty Database File: %s';
$ERROR_INVALID_CONFIG_TPL            = 'Invalid or Missing Configuration Template: %s';
