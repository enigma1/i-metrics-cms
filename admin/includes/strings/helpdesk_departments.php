...
define('TEXT_INFO_SERVER_CONNECT', 'Mail-Server to Connect:');
define('TEXT_INFO_SERVER_PROTOCOL', 'Protocol to Use:');
define('TEXT_INFO_SERVER_MAILBOX', 'MailBox to Use:');
define('TEXT_INFO_BODY_LIMIT', 'Body Size Limit (In Bytes):');
define('TEXT_INFO_TICKET_PREFIX', 'Ticket Prefix:');
define('TEXT_INFO_UNLIMITED', 'Unlimited');
define('TEXT_INFO_NOT_SET', 'Not Set');
define('TEXT_INFO_READ', 'Read Only');
...
define('TEXT_INFO_DELETE_WARN', 'This operation will also remove the associated department emails. If this is the default department you will need to manually specify another one.');
