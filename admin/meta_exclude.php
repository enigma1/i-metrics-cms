...
*/
  ...
  switch($action) {
    case 'setflag':
      ...
      tep_redirect(tep_href_link($g_script, tep_get_all_get_params(array('action','flag','tag_id')) ));
      break;
...
?>
          ...
          <div class="formArea"><?php echo tep_draw_form('rl_confirm', $g_script, tep_get_all_get_params(array('action')) . 'action=delete_confirm_multi', 'post'); ?><table class="tabledata" cellspacing="1">
...
?>
          <div class="formArea"><?php echo tep_draw_form('rl', $g_script, tep_get_all_get_params(array('action')) . 'action=delete_multi', 'post'); ?><table class="tabledata" cellspacing="1">
            <tr class="dataTableHeadingRow">
...
<?php
      ...
      while( $meta = $g_db->fetch_array($meta_query) ) {
        ...
        echo '                      <tr class="' . $row_class . '">';
?>
              <td><?php echo tep_draw_checkbox_field('tag_id[' . $meta['meta_exclude_key'] . ']', ($bCheck?'on':''), $bCheck ); ?></td>
...
<?php
      echo tep_image_submit('button_update.gif', TEXT_UPDATE, 'class="dflt" onclick="this.form.action=' . '\'' . tep_href_link($g_script, tep_get_all_get_params(array('action')) . 'action=update_multi') . '\'' . '"') . tep_image_submit('button_delete.gif', TEXT_DELETE, 'class="dflt" onclick="this.form.action=' . '\'' . tep_href_link($g_script, tep_get_all_get_params(array('action')) . 'action=delete_multi') . '\'' . '"');
?>
              </td>
            </tr>
          </table></form></div>
...
?>
          ...
          <div class="formArea"><?php echo tep_draw_form('mz', $g_script, tep_get_all_get_params(array('action')) . 'action=insert', 'post'); ?><table class="tabledata" cellspacing="1">
            <tr>
<?php
